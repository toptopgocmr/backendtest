...
<title>@yield('title', 'Dashboard') — TholadImmo Admin</title>
<link rel="icon" type="image/png" href="{{ asset('images/tholad-logo.png') }}">
<link rel="shortcut icon" type="image/png" href="{{ asset('images/tholad-logo.png') }}">
<link rel="apple-touch-icon" href="{{ asset('images/tholad-logo.png') }}">
...
<script>
  tailwind.config = {
    corePlugins: { preflight: false }, // ← évite d'écraser votre CSS custom existant
  }
</script>
